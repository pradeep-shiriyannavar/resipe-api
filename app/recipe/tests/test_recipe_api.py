...
def create_recipe(user, **params):
    """Crete and return a sample recipe"""
    defaults = {
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_clear_recipe_ingredient(self):
        """Test clearing a rcipes ingredients."""
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai Vegitale Curry')
        r2 = create_recipe(user=self.user, title='Sengada Holige')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        """Test uploading an imagge to a recipe."""
